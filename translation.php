<?php
// translation_history.php — separate page; currently mirrors bookings
// (Rename to transaction_history.php if you meant “transaction”)
...
<head>
  <meta charset="UTF-8" />
  <title>Translation History — Shine & Sparkle</title>
...
<div class="container">
  <div class="crumbs"><a href="index.php">Home</a> / <span>Translation History</span></div>
  <h1 class="title">Translation History</h1>
...
<script>
  ...
  function setupTable(scope){
    ...
    sizeEl.addEventListener('change', ()=>{ page=0; render(); });
    prev.addEventListener('click', ()=>{ if(page>0){ page--; render(); }});
    next.addEventListener('click', ()=>{ const size=parseInt(sizeEl.value,10); if((page+1)*size < filtered.length){ page++; render(); }});
    applyFilter();
  }
</script>
