<?php
// history.php — Wallet/Booking History only
...
<div class="container">
  <div class="crumbs"><a href="index.php">Home</a> / <span>History</span></div>
  <h1 class="title">Booking History</h1>

  <div class="card">
    <?php include __DIR__ . '/includes/table-history.php'; // re-used partial, now without export buttons ?>
  </div>
</div>

<script>
  // Setup the one table on this page
  document.querySelectorAll('.card').forEach(function(scope){
    setupTable(scope);
  });

  // same setup function you already had
